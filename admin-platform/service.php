...
if($_SESSION['admin_status']!="Administrator" AND $_SESSION['admin_status']!="Serviser")
{
...
<nav class="navbar navbar-expand-lg navbar-light" id="nav_bottom">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item">
        ...
        <div class="dropdown-menu" id="admin_date" aria-labelledby="navbarDropdown">
          ...
          <a href="#" class="btn btn-primary btn-block service_selector" id="date_save">Sačuvajte datum</a>
        </div>
      </li>
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu admin_checkbox" id="admin_model_service" aria-labelledby="navbarDropdown">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu admin_checkbox" id="admin_glitch_service"  aria-labelledby="navbarDropdown">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu admin_checkbox" aria-labelledby="navbarDropdown">
          <label class="dropdown-item form-check-label">
                  <input type="checkbox" class="form-check-input service_selector status" value="Na čekanju"> Na čekanju
          </label>
          <label class="dropdown-item form-check-label">
                  <input type="checkbox" class="form-check-input service_selector status" value="Servisiran"> Servisirano
          </label>
          <label class="dropdown-item form-check-label">
                  <input type="checkbox" class="form-check-input service_selector status" value="Odbijen"> Odbijeno
          </label>
        </div>
      </li>
    </ul>
    ...
    <form class="form-inline my-2 my-lg-0">
      <input class="form-control mr-sm-2" type="search" id="search_service" placeholder="Unesite E-mail adresu" aria-label="Search">
      <a href="#" class="btn service_selector">Pretraga</a>
    </form>
  </div>
</nav>
...
<div class="container-fluid">
  ...
  <div class="row">
    ...
    <div class="col-lg-8">
      <table class="table table-hover text-left" id="admin_table_servis">
        <thead>
          <tr>
            <th scope="col">Servis broj</th>
    ...
    <!--  <p id="admin_servis_data" class="text-center">Podaci o zahtevu:</p>-->
      <table class="table table-hover text-center" id="admin_servis_data">
        <thead>
          <tr>
