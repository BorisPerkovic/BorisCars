...
<nav class="navbar navbar-expand-lg navbar-light" id="nav_bottom">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item">
        ...
        <div class="dropdown-menu" id="admin_date" aria-labelledby="navbarDropdown">
          ...
          <a href="#" class="btn btn-block testDrive_selector" id="date_save">Sačuvajte datum</a>
        </div>
      </li>
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu admin_checkbox" aria-labelledby="navbarDropdown">
          <label class="dropdown-item form-check-label">
                  <input type="checkbox" class="form-check-input testDrive_selector status" value="Na čekanju"> Na čekanju
          </label>
          <label class="dropdown-item form-check-label">
                  <input type="checkbox" class="form-check-input testDrive_selector status" value="Servisiran"> Servisirano
          </label>
          <label class="dropdown-item form-check-label">
                  <input type="checkbox" class="form-check-input testDrive_selector status" value="Odbijen"> Odbijeno
          </label>
        </div>
      </li>
    </ul>
    ...
    <form class="form-inline my-2 my-lg-0">
      <input class="form-control mr-sm-2" type="search" id="search_DriveStatistics" placeholder="Unesite E-mail adresu" aria-label="Search">
      <a href="#" class="btn testDrive_selector">Pretraga</a>
    </form>
  </div>
</nav>
