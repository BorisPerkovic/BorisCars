...
<head>
    ...
    <!-- Custom JavaScript -->
    <script src="jscript/serviceStatistics.js"></script>
...
<nav class="navbar navbar-light bg-primary justify-content-between" id="admin_head">
  ...
  <form class="form-inline">
    <div class="btn-group profil">
        <button type="button" id="profil-text" class="btn profil-text dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
...
<nav class="navbar navbar-expand-lg navbar-light" id="nav_bottom">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item">
        ...
        <div class="dropdown-menu" id="admin_date" aria-labelledby="navbarDropdown">
          ...
          <a href="#" class="btn btn-primary btn-block common_selector" id="date_save">Sačuvajte datum</a>
        </div>
      </li>
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu admin_checkbox" id="admin_model" aria-labelledby="navbarDropdown">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu admin_checkbox" id="admin_glitch"  aria-labelledby="navbarDropdown">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu admin_checkbox" aria-labelledby="navbarDropdown">
          <label class="dropdown-item form-check-label">
                  <input type="checkbox" class="form-check-input common_selector status" value="Na čekanju"> Na čekanju
          </label>
          <label class="dropdown-item form-check-label">
                  <input type="checkbox" class="form-check-input common_selector status" value="Servisiran"> Servisirano
          </label>
          <label class="dropdown-item form-check-label">
                  <input type="checkbox" class="form-check-input common_selector status" value="Odbijen"> Odbijeno
          </label>
        </div>
      </li>
    </ul>
    ...
    <form class="form-inline my-2 my-lg-0">
      ...
      <a href="#" class="btn common_selector">Pretraga</a>
    </form>
  </div>
</nav>
